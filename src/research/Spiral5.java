...
public class Spiral5 {
    ...
    public Spiral5() throws Exception {
        new ATrack(""){
            @Override
...
//                dc.eraseTo(Point.fromRT(1, startTheta));
                ...
                while (rho+eraseSpace<1){
                    ...
                    boolean isActive2=isActive(dest.x, dest.y);
    ...
    private boolean isActive(double x, double y){
        return pixels[(int)Math.round(500-500*(y/2+.5))][(int)Math.round(500*(x/2+.5))]==1;
        //return x>-.5 && x<.5 && y>-.5 && y<.5;
    }

    public static void main(String args[]) throws Exception {
        Spiral5 me = new Spiral5();
    }
}