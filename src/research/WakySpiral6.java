 ...
 * Time: 8:44 AM
 */
public class WakySpiral6 {

    public WakySpiral6() throws Exception {
        new ATrack(""){
            @Override
...
//                dc.eraseTo(Point.fromRT(1, startTheta));
                ...
                while (true){
                    ...
                    double wiggleAmount=4*(1-Math.abs(2*Math.pow(rho, 1.1)-1));
                    double frequency=20;

                    //double optionAllRho=wiggleAmount * Math.sin(theta*frequency*rho) * eraseSpace;
                    double optionAllRho=wiggleAmount * Math.sin(theta*frequency+theta/20.0) * eraseSpace;
    ...
    public static void main(String args[]) throws Exception {
        WakySpiral6 me = new WakySpiral6();
    }
}