 ...
 * Time: 8:44 AM
 */
public class WakySpiral7 {

    public WakySpiral7() throws Exception {
        new ATrack(""){
            @Override
...
//                dc.eraseTo(Point.fromRT(1, startTheta));
                ...
                while (true){
                    ...
                    double optionAllRho=wiggleAmount * Math.sin(theta*frequency+theta/10.0) * eraseSpace;
                    //double optionAllRho=2.5 * eraseSpace;

                    boolean isActive=pixels[(int)Math.round(500-500*(y/2+.5))][(int)Math.round(500*(x/2+.5))]==0;
    ...
    public static void main(String args[]) throws Exception {
        WakySpiral7 me = new WakySpiral7();
    }
}